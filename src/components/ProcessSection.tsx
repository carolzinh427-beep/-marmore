...
export const ProcessSection: React.FC = () => {
  return (
    <section id="processo" className="py-24 md:py-32 bg-[#0A0A0C] text-white relative overflow-hidden border-t border-[#D4AF37]/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          {siteConfig.processSteps.map((step, idx) => (
            <div key={idx} className="relative z-10 flex flex-col space-y-6 group bg-[#121215] p-6 border border-[#D4AF37]/30 hover:border-[#D4AF37] transition-all duration-300 rounded-sm shadow-xl">
